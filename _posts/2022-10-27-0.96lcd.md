---
title: 关于WeAct Studio工作室的STM32H750开启LCD![产品图片](/assets/blog_res/2022-10-27-0.96lcd/产品图片.jpg)屏幕
...
WeAct的H750核心板因其亲民的价格和强悍的性能而备受欢迎，不过后来看到反客科技的感觉好像更香，言归正题，但是开发板的出厂的demo程序不提供，导致刷了OpenMV固件后，屏幕就成了摆设，秉承着花一分钱就得体验到一分货的信念，便有了这篇博客。

![产品图片](/assets/blog_res/2022-10-27-0.96lcd/产品图片.jpg)

# 准备工作

WeAct Studio STM32H750核心板

屏幕的启动代码（st7735.py文件）需要提前烧录到开发板
...
把ST7735驱动烧录后，启动OpenMV IDE连接开发板，运行代码

![OpenMV IDE](/assets/blog_res/2022-10-27-0.96lcd/OpenMV IDE.jpg)

![效果图片](/assets/blog_res/2022-10-27-0.96lcd/效果图片.jpg)